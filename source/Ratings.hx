...
class Ratings
{
    ...
    public static function CalculateRanking(score:Int,scoreDef:Int,nps:Int,maxNPS:Int,accuracy:Float):String
    {
        return
         ...
         (!PlayStateChangeables.botPlay || PlayState.loadRep ? "Score:" + (Conductor.safeFrames != 10 ? FlxStringUtil.formatMoney(score, false) + " (" + FlxStringUtil.formatMoney(scoreDef, false) + ")" : "" + FlxStringUtil.formatMoney(score, false)) + 		// Score
